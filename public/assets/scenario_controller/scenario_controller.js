...
let scenario = {};
    Object.assign(scenario, scenario_1,scenario_2,scenario_3);
    console.log(scenario);
   console.log(scenario_1,scenario_2,scenario_3);
    ...
    function renderScenario() {
        ...
        $(scenarioOpti.children[0].children).remove();


        for (let i = 0; i < scenario_+i.options.length; i++) {
